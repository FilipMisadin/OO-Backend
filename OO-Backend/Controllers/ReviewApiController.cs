...
namespace OO_Backend.Controllers
{
    ...
    public class ReviewApiController : ControllerBase
    {
        ...
        public ReviewApiController(ILogger<ReviewApiController> logger, DatabaseContext context)
        {
            _logger = logger;
            _database = context;
        }
        ...
        [HttpPut]
        [Route("review/{id}")]
        public IActionResult PutReview(long id, Review review)
        {
            if (id != review.Id)
            {
                return BadRequest();
        ...
        [HttpDelete]
        [Route("review/{id}")]
        public ActionResult<Review> DeleteReview(long id)
        {
            var review = _database.GetReview(id);
            if (review == null)
            {
