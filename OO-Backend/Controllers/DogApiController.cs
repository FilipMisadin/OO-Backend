...
namespace OO_Backend.Controllers
{
    ...
    public class DogApiController : ControllerBase
    {
        ...
        public DogApiController(ILogger<DogApiController> logger, DatabaseContext context)
        {
            _logger = logger;
            _database = context;
        }
        ...
        [Route("dogs")]
        [AllowAnonymous]
        public List<Dog> GetAllDogs() => _database.GetDogs();
        ...
        [HttpPut]
        [Route("dog/{id}")]
        public IActionResult PutDog(int id, Dog dog)
        {
            if (id != dog.Id)
            {
                return BadRequest();
        ...
        [HttpDelete]
        [Route("dog/{id}")]
        public ActionResult<Dog> DeleteDog(long id)
        {
            var dog = _database.GetDog(id);
            if (dog == null)
            {
